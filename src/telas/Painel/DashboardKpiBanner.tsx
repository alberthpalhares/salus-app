...
import { AnimacaoContador, AnimacaoLista, AnimacaoItemLista } from '../../componentes/ui/AnimacaoEntrada';
...
export const DashboardKpiBanner: React.FC<DashboardKpiBannerProps> = ({
  ...
  return (
    <AnimacaoLista className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
      {/* Card 1: Membros */}
      <AnimacaoItemLista>
        <div className="p-4 rounded-2xl bg-gradient-to-br from-teal-600 to-teal-800 text-white shadow-sm hover:shadow-lg transition-all duration-200 hover:-translate-y-0.5 flex flex-col justify-between relative overflow-hidden group">
          ...
          <div className="mt-3">
            <div className="text-2xl sm:text-3xl font-extrabold tracking-tight">
              <AnimacaoContador valor={membros.length} />
            </div>
      ...
      {/* Card 2: Condições */}
      <AnimacaoItemLista>
        <div className="p-4 rounded-2xl bg-gradient-to-br from-rose-500 to-rose-700 text-white shadow-sm hover:shadow-lg transition-all duration-200 hover:-translate-y-0.5 flex flex-col justify-between relative overflow-hidden group">
          <div className="flex items-center justify-between">
          ...
          <div className="mt-3">
            <div className="text-2xl sm:text-3xl font-extrabold tracking-tight">
              <AnimacaoContador valor={condicoesCount} />
            </div>
      ...
      {/* Card 3: Alertas */}
      <AnimacaoItemLista>
        <div className="p-4 rounded-2xl bg-gradient-to-br from-amber-500 to-amber-700 text-white shadow-sm hover:shadow-lg transition-all duration-200 hover:-translate-y-0.5 flex flex-col justify-between relative overflow-hidden group">
          <div className="flex items-center justify-between">
          ...
          <div className="mt-3">
            <div className="text-2xl sm:text-3xl font-extrabold tracking-tight">
              <AnimacaoContador valor={alertasCount} />
            </div>
      ...
      {/* Card 4: Medicamentos */}
      <AnimacaoItemLista>
        <div className="p-4 rounded-2xl bg-gradient-to-br from-indigo-600 to-purple-800 text-white shadow-sm hover:shadow-lg transition-all duration-200 hover:-translate-y-0.5 flex flex-col justify-between relative overflow-hidden group">
          <div className="flex items-center justify-between">
          ...
          <div className="mt-3">
            <div className="text-2xl sm:text-3xl font-extrabold tracking-tight">
              <AnimacaoContador valor={medicamentosEmUso.length} />
            </div>
