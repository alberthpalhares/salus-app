    ...
    <div className="min-h-screen bg-slate-900 text-slate-100 flex flex-col justify-center items-center p-4">
      <div className="max-w-xl w-full bg-slate-800/90 backdrop-blur-md rounded-2xl border border-slate-700/80 shadow-2xl p-8 space-y-8">
        ...
        <div className="space-y-4 pt-2">
          {error && (
            <div className="p-3 text-xs bg-red-500/10 border border-red-500/30 text-red-300 rounded-xl text-center">
              {error}
            </div>
          )}
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 bg-white hover:bg-slate-100 text-slate-900 font-medium py-3.5 px-4 rounded-xl shadow-lg transition-all duration-200 hover:shadow-xl active:scale-[0.99] disabled:opacity-50 text-sm cursor-pointer"
          >
